      ...
      <div className="grid lg:grid-cols-2 min-h-[680px]">
        ...
        <div className="relative overflow-hidden min-h-[480px] lg:min-h-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, rgba(0,30,20,0.55) 0%, rgba(0,20,14,0.82) 100%)",
            }}
          />
          ...
          <div className="relative z-10 p-10 lg:p-14 flex flex-col h-full justify-between">
            ...
            >
              ...
              >
                <div>
                  <p
                    className="italic font-semibold text-gray-700 text-sm mb-1.5"
                    style={{ fontFamily: "'Georgia', serif" }}
                  >
                    Location:
                  </p>
                  <div className="flex items-start gap-2 text-gray-500 text-xs">
                    <svg
                      className="w-4 h-4 mt-0.5 flex-shrink-0 text-[#004835]"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span>
                      House# 5 (2nd Floor), Road# 7, Block# F, <br />
                      Banani, Dhaka-1213.
                    </span>
                  </div>
                </div>
                <div className="border-l border-gray-200 pl-4">
                  ...
                  <div className="flex items-start gap-2 text-gray-500 text-xs">
                    ...
                    <span>
                      ...
                      <br /> +88 02 55041896, 02 226603195
                    </span>
                  </div>
                </div>
              </div>
        ...
        >
          {/* Background orbs */}
          <Orb
            style={{ width: 280, height: 280, top: -60, right: -60 }}
            dur={10}
          />
          <Orb
          ...
          <div className="relative z-10 w-full max-w-xl mx-auto px-8 lg:px-14 py-14">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <span
                  className="text-[10px] font-semibold uppercase tracking-widest text-[#004835]"
                  style={{ fontFamily: "sans-serif" }}
                >
                  Get in Touch
                </span>
              ...
              <h3
                ...
                style={{ fontFamily: "'Georgia', serif" }}
              >
                <em className="font-light italic">Send Us a Message</em>
              </h3>
              {/* Animated underline */}
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #004835, rgba(0,72,53,0.15))",
                }}
                initial={{ width: 0 }}
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #004835, rgba(0,72,53,0.2))",
                }}
                ...
                {sent ? (
                  <motion.div
                    ...
                    style={{
                      ...
                      border: "1px solid rgba(0,72,53,0.2)",
                    }}
                  >
                    <motion.span
                    ...
                    <span
                      className="text-[#004835] text-sm font-semibold"
                      style={{ fontFamily: "sans-serif" }}
                    >
                      Message Sent!
                    </span>
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={loading}
                    className="inline-flex items-center gap-3 text-[14px] font-semibold px-6 py-3.5 rounded-full disabled:opacity-60 disabled:cursor-not-allowed"
                    style={{
                      background: "#f3f2ee",
                      color: "#111",
                    ...
                    whileHover={
                      !loading
                        ? { backgroundColor: "#004835", color: "#fff" }
                        : {}
                    }
                  ...
                  >
                    ...
                    <motion.span
                      ...
                      style={{ background: "#004835" }}
                      whileHover={!loading ? { backgroundColor: "#fff" } : {}}
                      transition={{ duration: 0.25 }}
                    >
                      {loading ? (
                        <svg
